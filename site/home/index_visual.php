...
<div id="content_words">
    <div onclick="detail(this)" oncontextmenu="remove_item(this)"  class="word_item">
        <div>
            <p class="define">Hello</p>
            <p class="meaning">Xin chào</p>
        </div>
        <div class="interaction">
            <p>#adj</p>
            <p style="text-align: center">Hello everyone . My name is Tunkit</p>    
            <!-- <i class="fa-solid fa-plus fa-2xl"></i> -->
            <img src="https://cdn-icons-png.flaticon.com/512/4257/4257483.png" width="30px">
